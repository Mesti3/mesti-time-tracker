...
public final class TimeTrackerPersistentState {
    ...
    public String ideUserPattern = DEFAULT_IDE_USER_PATTERN;
    public String gitUserPattern = DEFAULT_GIT_USER_PATTERN;
    ...
    public void setDefaultsFrom(final TimeTrackerPersistentState state) {
        ...
        this.ideUserPattern = state.ideUserPattern;
        this.gitUserPattern = state.gitUserPattern;
    }
    ...
    public static transient String DEFAULT_IDE_USER_PATTERN = "";
    public static transient String DEFAULT_GIT_USER_PATTERN = "";
}
